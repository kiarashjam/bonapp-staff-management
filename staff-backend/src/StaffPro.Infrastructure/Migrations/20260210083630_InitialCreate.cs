        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakAfterMinutes = table.Column<int>(type: "int", nullable: false),
                    BreakDurationMinutes = table.Column<int>(type: "int", nullable: false),
                    ClockInGraceMinutes = table.Column<int>(type: "int", nullable: false),
                    ClockInLateThresholdMinutes = table.Column<int>(type: "int", nullable: false),
                    ClockRoundingMinutes = table.Column<int>(type: "int", nullable: false),
                    OvertimeWeeklyThreshold = table.Column<int>(type: "int", nullable: false),
                    OvertimeDailyThreshold = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccrualRatePerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakDurationMinutes = table.Column<int>(type: "int", nullable: false),
                    BreakIsPaid = table.Column<bool>(type: "bit", nullable: false),
                    Color = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Roles_Custom", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Roles_Custom_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Roles_Custom_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchedulePeriods_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StaffingRequirements_Roles_Custom_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles_Custom",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StaffingRequirements_SchedulePeriods_SchedulePeriodId",
                        column: x => x.SchedulePeriodId,
                        principalTable: "SchedulePeriods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StaffingRequirements_ShiftTemplates_ShiftTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationRoles", x => new { x.StationId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_StationRoles_Roles_Custom_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles_Custom",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StationRoles_Stations_StationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailabilityOverrides_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RoundedTimestamp = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Source = table.Column<int>(type: "int", nullable: false),
                    Latitude = table.Column<double>(type: "float", nullable: true),
                    Longitude = table.Column<double>(type: "float", nullable: true),
                    GpsAccuracyMeters = table.Column<double>(type: "float", nullable: true),
                    IpAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClockEntries_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractedHoursPerWeek = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HourlyRateCents = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    SalaryMonthlyCents = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Contracts_ActiveContractId",
                        column: x => x.ActiveContractId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeRoles_Roles_Custom_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles_Custom",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarriedOver = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    Adjustment = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecurringAvailabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecurringAvailabilities_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringAvailabilities_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_Roles_Custom_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles_Custom",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_SchedulePeriods_SchedulePeriodId",
                        column: x => x.SchedulePeriodId,
                        principalTable: "SchedulePeriods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_Stations_StationId",
                        column: x => x.StationId,
                        principalTable: "Stations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimeOffRequests_LeaveTypes_LeaveTypeId",
                        column: x => x.LeaveTypeId,
                        principalTable: "LeaveTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimeOffRequests_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NightHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    WeekendHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    BreakHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    NetPayableHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    RegularPayCents = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    OvertimePayCents = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalGrossPayCents = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakMinutes = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    RegularHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    OvertimeHours = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimesheetEntries_ShiftAssignments_ShiftAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityOverrides_EmployeeId",
                table: "AvailabilityOverrides",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityOverrides_OrganizationId",
                table: "AvailabilityOverrides",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_ClockEntries_EmployeeId_Timestamp",
                table: "ClockEntries",
                columns: new[] { "EmployeeId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_ClockEntries_OrganizationId",
                table: "ClockEntries",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_ClockEntries_ShiftAssignmentId",
                table: "ClockEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_ActiveContractId",
                table: "Employees",
                column: "ActiveContractId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_OrganizationId_Status",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringAvailabilities_EmployeeId",
                table: "RecurringAvailabilities",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringAvailabilities_OrganizationId",
                table: "RecurringAvailabilities",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Roles_Custom_DepartmentId",
                table: "Roles_Custom",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Roles_Custom_OrganizationId",
                table: "Roles_Custom",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_SchedulePeriods_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_SchedulePeriodId_Date",
                table: "ShiftAssignments",
                columns: new[] { "SchedulePeriodId", "Date" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_StationId",
                table: "ShiftAssignments",
                column: "StationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffingRequirements_RoleId",
                table: "StaffingRequirements",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_StaffingRequirements_SchedulePeriodId",
                table: "StaffingRequirements",
                column: "SchedulePeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_StaffingRequirements_ShiftTemplateId",
                table: "StaffingRequirements",
                column: "ShiftTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_StationRoles_RoleId",
                table: "StationRoles",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeOffRequests_LeaveTypeId",
                table: "TimeOffRequests",
                column: "LeaveTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeOffRequests_OrganizationId",
                table: "TimeOffRequests",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetEntries_ShiftAssignmentId",
                table: "TimesheetEntries",
                column: "ShiftAssignmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_EmployeeId_PeriodStart",
                table: "Timesheets",
                columns: new[] { "EmployeeId", "PeriodStart" });

            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_OrganizationId",
                table: "Timesheets",
                column: "OrganizationId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AvailabilityOverrides_Employees_EmployeeId",
                table: "AvailabilityOverrides",
                column: "EmployeeId",
                principalTable: "Employees",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClockEntries_Employees_EmployeeId",
                table: "ClockEntries",
                column: "EmployeeId",
                principalTable: "Employees",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClockEntries_ShiftAssignments_ShiftAssignmentId",
                table: "ClockEntries",
                column: "ShiftAssignmentId",
                principalTable: "ShiftAssignments",
                principalColumn: "Id");
